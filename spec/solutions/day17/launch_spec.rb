...
RSpec.describe Launch do
  ...
  describe "#result" do
    ...
    context "with many winning sets of initial velocities" do
      [
        ...
        it "is Launch::ON_TARGET (#{x}, #{y})" do
          # subject and lets don't like being shadowed in loops :(
          launch = described_class.new(x_target_range, y_target_range, x, y)
          expect(launch.result).to eq Launch::ON_TARGET
        end
      end
    end
  end
